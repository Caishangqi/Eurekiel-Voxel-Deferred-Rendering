...
void SceneUnitTest_VertexLayoutRegistration::Render()
{
    ...
    g_theRendererSubsystem->UseProgram(m_cube1ShaderProgram, {{RenderTargetType::ColorTex, 0}, {RenderTargetType::DepthTex, 0}});
    ...
    g_theRendererSubsystem->UseProgram(m_cube2ShaderProgram, {{RenderTargetType::ColorTex, 0}, {RenderTargetType::DepthTex, 0}});
