/// Tone mapping library — Lottes 2016 HDR → LDR conversion
/// Reference: CR composite5.glsl:36-87, Lottes GDC 2016
/// "Advanced Techniques and Optimization of HDR Color Pipelines"
///
/// Dependencies: common.hlsl (Luma), settings.hlsl
/// Usage: #include in composite5.ps.hlsl (or any pass needing tonemap)

#ifndef LIB_TONEMAP_HLSL
#define LIB_TONEMAP_HLSL
